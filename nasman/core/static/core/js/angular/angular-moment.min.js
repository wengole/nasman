        ...
        return a.module("angularMoment", []).constant("angularMomentConfig", {
            ...
            return function (g, h, i) {
                function j() {
                    var a;
                    if (e.serverTime) {
                        var b = (new Date).getTime(), d = b - v + e.serverTime;
                        a = c(d)
                    } else a = c();
                    return a
                }
                ...
                function l(a) {
                    var c = j().diff(a, "day"), d = t && c >= t;
                    if (h.text(d ? a.format(u) : a.from(j(), r)), s && !h.attr("title") && h.attr("title", a.local().format(s)), !d) {
                        var e = Math.abs(j().diff(a, "minute")), f = 3600;
                        1 > e ? f = 1 : 60 > e ? f = 30 : 180 > e && (f = 300), p = b.setTimeout(function () {
                            l(a)
                        }, 1e3 * f)
                    }
                }
                ...
                var o, p = null, q = f.format, r = e.withoutSuffix, s = e.titleFormat, t = e.fullDateThreshold, u = e.fullDateFormat, v = (new Date).getTime(), w = f.preprocess, x = i.amTimeAgo, y = "TIME" === h[0].nodeName.toUpperCase();
            ...
            this.preprocessors = {
                ...
                return b = b || e.timezone, a && b && (a.tz ? a = a.tz(b) : d.warn("angular-moment: timezone specified but moment.tz() is undefined. Did you forget to include moment-timezone.js?")), a
            }
