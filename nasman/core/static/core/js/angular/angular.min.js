...
(function (M, Y, t) {
    ...
    function Oe() {
        ...
        this.$get = ["$filter", "$sniffer", function (c, d) {
            ...
            var q = {csp: d.csp, expensiveChecks: !1}, u = {
                csp: d.csp,
                expensiveChecks: !0
            };
    ...
    var yd = function (a) {
        ...
        }], be = ic("", !0), de = ic("Odd", 0), ce = ic("Even", 1), ee = Ia({
                        ...
                        function p() {
                            ...
                            for (B = c.length; x < B; x++) {
                                ...
                                for (D = l.length; F < D; F++)d = l[F], (t = r[F + 1]) ? (I = t.element, t.label !== d.label && (m(N, t.label, !1), m(N, d.label, !0), I.text(t.label = d.label),
                                    I.prop("label", t.label)), t.id !== d.id && I.val(t.id = d.id), I[0].selected !== d.selected && (I.prop("selected", t.selected = d.selected), Qa && I.prop("selected", t.selected))) : ("" === d.id && z ? U = z : (U = w.clone()).val(d.id).prop("selected", d.selected).attr("selected", d.selected).prop("label", d.label).text(d.label), r.push(t = {
                                    element: U,
                                    label: d.label,
                                    id: d.id,
                                    selected: d.selected
